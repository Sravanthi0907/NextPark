...
Deploy NextPark to Render with persistent data storage by following these steps:

#### Step 1 — Create a Web Service
Create a new **Web Service** on Render and link it to your GitHub repository containing the NextPark code.

#### Step 2 — Configure Environment & Commands
...
Render's container filesystem resets on restarts. To permanently persist user accounts and bookings:
1. Go to the **Disks** section of your Web Service in the Render Dashboard.
2. Click **Add Disk**.
3. Configure the disk:
   - **Name**: `nextpark-data`
   - **Mount Path**: `/data`
   - **Size**: `1 GiB` (minimum allowed)

#### Step 4 — Define Environment Variables
Add the following variables in the **Environment** tab of your Render service:
- `FLASK_ENV`: `production`
- `SECRET_KEY`: *[A strong, random secret string for session security]*
- `DATA_DIR`: `/data` *(Points all databases to the mounted persistent disk folder)*

---

## 🚗 Vehicle Pricing Rates
